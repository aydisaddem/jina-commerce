...
<article className="product-card" aria-label="Sweat oversize- grey">
  <img
  ...
  <div className="product-info">
    <h2 className="product-title">Sweat oversize à capuche - gris</h2>
    ...
    <p className="product-price" aria-label="Product price">
     ...
     <div className="qty-row">
      <button type="button" className="qty-btn" onClick={handleQtyDecrease}>
        −
      </button>
      <input
        type="number"
        ...
        min="1"
      />
      <button type="button" className="qty-btn" onClick={handleQtyIncrease}>
        +
      </button>
    </div>
